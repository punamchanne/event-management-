...
export default function ManageProgramPage() {
  ...
  const validateProgram = () => {
    ...
    if (!p.eventDate) {
      console.warn("Validation failed: Event Date is missing.");
  ...
  const handleAddProgram = async () => {
    ...
    try {
      ...
      toast.promise(res, {
        ...
        error: (err: unknown) => {
          console.error("Program operation failed:", err);
          return `Error: ${err}`;
        },
      });
    } catch (error) {
